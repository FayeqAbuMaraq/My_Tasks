<x-app-layout>
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-dark border-end border-5 border-success pe-3">تعديل المستخدم: {{ $user->name }}</h3>
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('dashboard.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold small">كلمة المرور (اتركها فارغة لعدم التغيير)</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="address" class="form-control bg-light border-0" value="{{ $user->address }}">
                        </div>
